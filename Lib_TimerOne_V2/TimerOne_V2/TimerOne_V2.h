...
////////////////////////////TIMER_ONE_V2////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
#ifndef TIMERONE_V2_H
#define TIMERONE_V2_H
...
class TimerOne_V2
{
	public:
		...
		static TimerOne_V2 *_instance; // pointer to instance of Timer
		void handleInterrupt(); // called routine when running _isr0()

		TimerOne_V2(void); //ctor
		~TimerOne_V2(void); //dtor

		void begin();
		void add_task(GeneralFunction f, int time_style, double time); // adds a function to time trigger

		//TimerOne _subTimer;              // preinstatiate
		
	protected:
		int _us_period; // period in microseconds
		int _max_tasks; // maximmum time triggered functions
		int _tasks_in; // number of functions triggered by the timer

		GeneralFunction *_TasksArray; // array where are stored functions to time trigger
